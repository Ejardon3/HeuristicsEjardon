...
Es el criterio que establece que productos deden meterse a la mochila, dando prioridad en este caso al volumen'''
...
D = np.array(sorted(D, key=lambda x: x[1]))#Orden creciente
#print(D)
...
while(b > volumen):
    ...
    if k == 10:#Cao ideal, pero no se necesitaria optimizar
